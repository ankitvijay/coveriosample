...

{
...

    {
...

        {
            ...
            Assert.AreEqual((object) expected, fMB1.Multiply(2));

            Assert.AreEqual((object) fMB1, fMB1.Multiply(1));
...

        {
            ...
            Assert.AreEqual((object) expected, fMB1.Negate());
...

        {
            ...
            Assert.AreEqual((object) expected, fMB1.Add(f14CHF));
...

        {
            ...
            Assert.AreEqual((object) expected, fMB1.Subtract(fMB2));
...

        {
            ...
            Assert.AreEqual((object) expected, fMB1.Add(fMB2));
...

        {
            ...
            Assert.AreEqual((int) fMB1.GetHashCode(), (int) equal.GetHashCode());
...

        {
            ...
            Assert.AreEqual((object) expectedBag, (object) moneyBag);
...

        {
            ...
            Assert.AreEqual((object) expected, f14CHF.Add(fMB1));
